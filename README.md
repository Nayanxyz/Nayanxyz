...
*   **Swarm AI Agent (Travily):** A backend and mobile frontend system utilizing a multi-agent swarm architecture for complex task delegation and search integration.
